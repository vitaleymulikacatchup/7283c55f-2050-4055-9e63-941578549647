...
export const metadata: Metadata = {
  title: "Brew & Bean - Premium Specialty Coffee Shop",
  description: "Handcrafted specialty coffee made with passion. Ethically sourced beans roasted fresh daily by expert baristas. Your perfect cup awaits.",
  keywords: "specialty coffee, espresso, cappuccino, coffee shop, cafe, barista, cold brew",
  metadataBase: new URL("https://brewandbean.com"),
  alternates: {
    canonical: "https://brewandbean.com"
  },
  openGraph: {
    title: "Brew & Bean - Premium Specialty Coffee",
    description: "Experience handcrafted coffee made with passion and expertise",
    type: "website",
    siteName: "Brew & Bean",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1764150219985-qmx8r778.jpg",
  ...
  twitter: {
    ...
    title: "Brew & Bean - Premium Specialty Coffee",
    description: "Handcrafted coffee made with passion"
  },
  robots: {
    index: true,
    follow: true
